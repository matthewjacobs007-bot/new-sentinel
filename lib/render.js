...
export function activatePage(tenant, baseUrl, { stripeConfigured = false, cancelled = false, isMsp = false } = {}) {
    ...
    <div style="width:100%;max-width:460px">
      ...
      <div class="card elev" style="padding:32px;position:relative;overflow:hidden">
        ...
        <form method="post" action="${baseUrl}/activate/checkout">
          ...
          <button class="btn primary" type="submit" style="width:100%;justify-content:center;padding:12px;font-size:14.5px">Subscribe with Stripe →</button>
        </form>
        <p class="muted" style="font-size:11.5px;margin:10px 0 0;text-align:center;line-height:1.5">Cancel anytime. Billing is monthly, based on your active user count at scan time.</p>
        ` : `
